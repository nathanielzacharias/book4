...
/*
		...
		else if (whichMachine == 0) { showabout();}
...
function showlogin0()
{
	page_load();
	div_hide('#content_div');
	$.get('login0.php?new_user0', function(data) { $('#content_div').html(data); div_fadein('#content_div'); page_loaded(); input_focus('#user_name_input0'); });
}
...
function showreservations()
{
	...
	if (whichMachine == 1) {
		$.get('reservation1.php', function(data)
		{
			$('#content_div').html(data);
			div_fadein('#content_div');

			$.get('reservation1.php?week='+global_week_number, function(data)
			{
		...
		$.get('reservation2.php', function(data)
		{
			$('#content_div').html(data);
			div_fadein('#content_div');

			$.get('reservation2.php?week='+global_week_number, function(data)
			{
				$('#reservation_table_div').html(data).slideDown('slow', function() { setTimeout(function() { div_fadein('#reservation_table_div'); }, 250); });
				page_loaded();
			});
		...
		$.get('reservation3.php', function(data)
		{
			$('#content_div').html(data);
			div_fadein('#content_div');

			$.get('reservation3.php?week='+global_week_number, function(data)
			{
				$('#reservation_table_div').html(data).slideDown('slow', function() { setTimeout(function() { div_fadein('#reservation_table_div'); }, 250); });
				page_loaded();
			});
		...
		$.get('reservation4.php', function(data)
		{
			$('#content_div').html(data);
			div_fadein('#content_div');

			$.get('reservation4.php?week='+global_week_number, function(data)
			{
				$('#reservation_table_div').html(data).slideDown('slow', function() { setTimeout(function() { div_fadein('#reservation_table_div'); }, 250); });
				page_loaded();
			});
		...
		$.get('reservation5.php', function(data)
		{
			$('#content_div').html(data);
			div_fadein('#content_div');

			$.get('reservation5.php?week='+global_week_number, function(data)
			{
				$('#reservation_table_div').html(data).slideDown('slow', function() { setTimeout(function() { div_fadein('#reservation_table_div'); }, 250); });
				page_loaded();
			});
...
function showweek(week, option)
{
	...
	else
	{
		...
		if (whichMachine == 1) {
			$.get('reservation1.php?week='+week, function(data)
			{
			...
			$.get('reservation2.php?week='+week, function(data)
			{
				$('#reservation_table_div').html(data);
				$('#week_number_span').html(week);
				div_fadein('#reservation_table_div');
			...
			$.get('reservation3.php?week='+week, function(data)
			{
				$('#reservation_table_div').html(data);
				$('#week_number_span').html(week);
				div_fadein('#reservation_table_div');
			...
			$.get('reservation4.php?week='+week, function(data)
			{
				$('#reservation_table_div').html(data);
				$('#week_number_span').html(week);
				div_fadein('#reservation_table_div');
			...
			$.get('reservation5.php?week='+week, function(data)
			{
				$('#reservation_table_div').html(data);
				$('#week_number_span').html(week);
				div_fadein('#reservation_table_div');
...
function showcp1()
{
	page_load();
	div_hide('#content_div');
	$.get('cp1.php', function(data) { $('#content_div').html(data); div_fadein('#content_div'); page_loaded(); });
}
...
function page_loaded(page, whichMachine)
{
	// All
	$.get('main.php?day_number', function(data)
	{
		...
		{
			notify('Day has changed. Refreshing...', '300');
	...
	read_reservation_details(whichMachine);
...
function create_user0()
{
	var user_name0 = $('#user_name_input0').val();
	var user_email0 = $('#user_email_input0').val();
//	var user_password = $('#user_password_input').val();
//	var user_password_confirm = $('#user_password_confirm_input').val();

	if(user_name0 != user_email0)
	{
		$('#new_user_message_p0').html('<span class="error_span">PATS numbers do not match</span>').slideDown('fast');
//		$('#user_password_input').val('');
//		$('#user_password_confirm_input').val('');
	//	input_focus('#user_password_input');
	}
	...
	{
		$('#new_user_message_p0').html('Registering your PATS...').slideDown('fast');

		$.post('login0.php?create_user0', { user_name0: user_name0, user_email0: user_email0 }, function(data)
		{
			if(data == 1)
			{
				input_focus();
				...
				setTimeout(function()
				{
					$('#new_user_message_p0').html('PATS registered successfully! ');
					setTimeout(function() { window.location.replace(''); }, 2000);
				}, 1000);
			}
			else
...
function toggle_reservation_time(id, week, day, time, from)
{
	...
	if(user_name == '')
	{
		...
		if (whichMachine == 1) {
			$.post('reservation1.php?make_reservation', { week: week, day: day, time: time }, function(data)
			{
				if(data == 1)
				{
			...
			$.post('reservation2.php?make_reservation', { week: week, day: day, time: time }, function(data)
			{
				if(data == 1)
				{
					setTimeout(function() { read_reservation(id, week, day, time); }, 1000);
			...
			$.post('reservation3.php?make_reservation', { week: week, day: day, time: time }, function(data)
			{
				if(data == 1)
				{
					setTimeout(function() { read_reservation(id, week, day, time); }, 1000);
			...
			$.post('reservation4.php?make_reservation', { week: week, day: day, time: time }, function(data)
			{
				if(data == 1)
				{
					setTimeout(function() { read_reservation(id, week, day, time); }, 1000);
			...
			$.post('reservation5.php?make_reservation', { week: week, day: day, time: time }, function(data)
			{
				if(data == 1)
				{
					setTimeout(function() { read_reservation(id, week, day, time); }, 1000);
		...
		if(offclick_event == 'mouseup' || from == 'details')
		{
			...
			else if(user_name == session_user_name || session_user_is_admin == '1')
			{
				...
				if(delete_confirm)
				{
					...
					if (whichMachine == 1) {
						$.post('reservation1.php?delete_reservation', { week: week, day: day, time: time }, function(data)
						{
							if(data == 1)
							{
								setTimeout(function() { read_reservation(id, week, day, time); }, 1000);
						...
						$.post('reservation2.php?delete_reservation', { week: week, day: day, time: time }, function(data)
						{
							if(data == 1)
							{
								setTimeout(function() { read_reservation(id, week, day, time); }, 1000);
						...
						$.post('reservation3.php?delete_reservation', { week: week, day: day, time: time }, function(data)
						{
							if(data == 1)
							{
								setTimeout(function() { read_reservation(id, week, day, time); }, 1000);
						...
						$.post('reservation4.php?delete_reservation', { week: week, day: day, time: time }, function(data)
						{
							if(data == 1)
							{
								setTimeout(function() { read_reservation(id, week, day, time); }, 1000);
						...
						$.post('reservation5.php?delete_reservation', { week: week, day: day, time: time }, function(data)
						{
							if(data == 1)
							{
								setTimeout(function() { read_reservation(id, week, day, time); }, 1000);
...
function read_reservation(id, week, day, time)
{
	...
	if (whichMachine == 1) {	$.post('reservation1.php?read_reservation', { week: week, day: day, time: time }, function(data) { $(id).html(data); });}
	else if (whichMachine == 2) {	$.post('reservation2.php?read_reservation', { week: week, day: day, time: time }, function(data) { $(id).html(data); });}
	else if (whichMachine == 3) {	$.post('reservation3.php?read_reservation', { week: week, day: day, time: time }, function(data) { $(id).html(data); });}
	else if (whichMachine == 4) {	$.post('reservation4.php?read_reservation', { week: week, day: day, time: time }, function(data) { $(id).html(data); });}
	else if (whichMachine == 5) {	$.post('reservation5.php?read_reservation', { week: week, day: day, time: time }, function(data) { $(id).html(data); });}
	else if (whichMachine == 0) { showabout();}
}
...
function read_reservation_details(id, week, day, time)
{
	if(typeof id != 'undefined' && $(id).html() != '' && $(id).html() != 'Wait...')
	{
		if($('#reservation_details_div').is(':hidden'))
		{
			...
			if (whichMachine == 1) {
				$.post('reservation1.php?read_reservation_details', { week: week, day: day, time: time }, function(data)
				{
					setTimeout(function()
					{
						if(data == 0)
				...
				$.post('reservation2.php?read_reservation_details', { week: week, day: day, time: time }, function(data)
				{
					setTimeout(function()
					{
						if(data == 0)
				...
				$.post('reservation3.php?read_reservation_details', { week: week, day: day, time: time }, function(data)
				{
					setTimeout(function()
					{
						if(data == 0)
				...
				$.post('reservation4.php?read_reservation_details', { week: week, day: day, time: time }, function(data)
				{
					setTimeout(function()
					{
						if(data == 0)
				...
				$.post('reservation5.php?read_reservation_details', { week: week, day: day, time: time }, function(data)
				{
					setTimeout(function()
					{
						if(data == 0)
...
$(document).ready( function()
{
	...
	$(document).on('submit', '#login_form0', function() { login0(); return false; });
	$(document).on('submit', '#new_user_form0', function() { create_user0(); return false; });
