...
?>
	...
	<label for="user_name_input">Short Name:</label><br>
	<input type="text" id="user_name_input"><br><br>
	<label for="user_email_input">Confirm Short Name:</label><br>
...
?>
	...
	<label for="user_email_input">Short name</label><br><input type="text" id="user_email_input" value="<?php echo get_login_data('user_email'); ?>" autocapitalize="off"><br><br>
...
-->
	<id="user_password_input" value=1234><br><br>
