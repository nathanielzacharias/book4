...
{
	$con = mysqli_connect(global_mysqli_server, global_mysqli_user, global_mysqli_password, global_mysqli_database)or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');
	$query = mysqli_query($con, "SELECT * FROM " . global_mysqli_configuration_table)or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');
...
function validate_user_name0($user_name0)
{
	if(preg_match('/^[0-9]{6}$/i', $user_name0))
	{
		return(true);
	}
}
...
function user_name_exists($user_name)
{
	...
	$query = mysqli_query($con, "SELECT * FROM " . global_mysqli_users_table . " WHERE user_name='$user_name'")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');
...
function user_email_exists($user_email)
{
	...
	$query = mysqli_query($con, "SELECT * FROM " . global_mysqli_users_table . " WHERE user_email='$user_email'")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');
...
function login($user_email, $user_password)
{
	...
	$query = mysqli_query($con, "SELECT * FROM " . global_mysqli_users_table . " WHERE user_email='$user_email' AND user_password='$user_password_encrypted' OR user_email='$user_email' AND user_password='$user_password'")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');
...
function check_login()
{
	if(isset($_SESSION['logged_in']))
	{
		...
		$query = mysqli_query($con, "SELECT * FROM " . global_mysqli_users_table . " WHERE user_id='$user_id'")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');
...
//function create_user($user_name,  $user_password, $user_secret_code)
{
	$con = mysqli_connect(global_mysqli_server, global_mysqli_user, global_mysqli_password, global_mysqli_database)or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');
...
/*	elseif(user_email_exists($user_email) == true)
	...
	*/
	else
	{
		...
		$query = mysqli_query($con, "SELECT * FROM " . global_mysqli_users_table . "")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');
		...
		mysqli_query($con, "INSERT INTO " . global_mysqli_users_table . " (user_is_admin,user_email,user_password,user_name,user_reservation_reminder) VALUES ($user_is_admin,'$user_email','$user_password','$user_name','0')")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');
	...
	//	setcookie(global_cookie_prefix . '_user_email', time() + 3600 * 24 * intval(global_remember_login_days));
	//	setcookie(global_cookie_prefix . '_user_password', $user_password, time() + 3600 * 24 * intval(global_remember_login_days));
...
function create_user0($user_name0, $user_email0)
//function create_user($user_name,  $user_password, $user_secret_code)
{
	$con = mysqli_connect(global_mysqli_server, global_mysqli_user, global_mysqli_password, global_mysqli_database)or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');

	if(validate_user_name0($user_name0) != true)
	{
		return('<span class="error_span">PATS number must be 6 digits only.</span>');
	}
/*	elseif(validate_user_email($user_email) != true)
	{
		return('<span class="error_span">Email must be a valid email address and be no more than 50 characters long</span>');
...
/*	elseif(user_email_exists($user_email) == true)
	...
	*/
	else
	{
		...
		$query = mysqli_query($con, "SELECT * FROM " . global_mysqli_users_table0 . "")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');

		mysqli_query($con, "INSERT INTO " . global_mysqli_users_table0 . " (pats, registration_time, user_is_admin,user_email,user_password,user_name,user_reservation_reminder) VALUES ($user_name0, now(), '0','0','0','0','0')")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');
...
function list_admin_users()
{
	...
	$query = mysqli_query($con, "SELECT * FROM " . global_mysqli_users_table . " WHERE user_is_admin='1' ORDER BY user_name")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');
...
function read_reservation($week, $day, $time)
{
	...
	$query = mysqli_query($con, "SELECT * FROM " . global_mysqli_reservations_table . " WHERE reservation_week='$week' AND reservation_day='$day' AND reservation_time='$time'")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');
...
function make_reservation($week, $day, $time)
{
	...
	{
		mysqli_query($con, "INSERT INTO " . global_mysqli_reservations_table . " (reservation_made_time,reservation_week,reservation_day,reservation_time,reservation_price,reservation_user_id,reservation_user_email,reservation_user_name) VALUES (now(),'$week','$day','$time','$price','$user_id','$user_email','$user_name')")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');
	...
	else
	{
		...
		if(mysqli_num_rows($query) < 1)
		{
			...
			mysqli_query($con, "INSERT INTO " . global_mysqli_reservations_table . " (reservation_made_time,reservation_year,reservation_week,reservation_day,reservation_time,reservation_price,reservation_user_id,reservation_user_email,reservation_user_name) VALUES (now(),'$year','$week','$day','$time','$price','$user_id','$user_email','$user_name')")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');
...
function delete_reservation($week, $day, $time)
{
	...
	else
	{
		...
		{
			mysqli_query($con, "DELETE FROM " . global_mysqli_reservations_table . " WHERE reservation_week='$week' AND reservation_day='$day' AND reservation_time='$time'")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');
...
function list_users()
{
	...
	$query = mysqli_query($con, "SELECT * FROM " . global_mysqli_users_table . " ORDER BY user_is_admin DESC, user_name")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');

	$users = '<table id="users_table"><tr><th>ID</th><th>Admin</th><th>Name</th><th>Email</th><th>Reminders</th><th>Slots used</th><th>Cost</th><th></th></tr>';
...
function list_users1()
{
	$con = mysqli_connect(global_mysqli_server, global_mysqli_user, global_mysqli_password, global_mysqli_database)or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');

	$query = mysqli_query($con, "SELECT * FROM " . global_mysqli_users_table)or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');

	$users2 = '<table id="users_table"><tr><th>Tool</th><th>Current Status</th></tr>';

	while($user2 = mysqli_fetch_array($query))
	{
		$users2 .= '<tr id="user_tr_' . $user2['user_id'] . '"><td>' .  '</td><td><label for="user_radio_' . $user2['user_id'] . '">' . $user2['user_name'] . '</label></td><td>' .   '</label></td><td></td><td></td></tr>';
	}
...
function reset_user_password($user_id)
{
	...
	mysqli_query($con, "UPDATE " . global_mysqli_users_table . " SET user_password='$password_encrypted' WHERE user_id='$user_id'")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');
...
function change_user_permissions($user_id)
{
	...
	{
		mysqli_query($con, "UPDATE " . global_mysqli_users_table . " SET user_is_admin = 1 - user_is_admin WHERE user_id='$user_id'")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');
...
function delete_user_data($user_id, $data)
{
	...
	else
	{
		...
		{
			mysqli_query($con, "DELETE FROM " . global_mysqli_reservations_table . " WHERE reservation_user_id='$user_id'")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');
		}
		elseif($data == 'user')
		{
			mysqli_query($con, "DELETE FROM " . global_mysqli_users_table . " WHERE user_id='$user_id'")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');
			mysqli_query($con, "DELETE FROM " . global_mysqli_reservations_table . " WHERE reservation_user_id='$user_id'")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');
		}
...
function delete_all($data)
{
	...
	{
		mysqli_query($con, "DELETE FROM " . global_mysqli_users_table . "")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');
		mysqli_query($con, "DELETE FROM " . global_mysqli_reservations_table . "")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');
	}
...
function save_system_configuration($price)
{
	...
	{
		mysqli_query($con, "UPDATE " . global_mysqli_configuration_table . " SET price='$price'")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');
	}
...
function count_reservations($user_id)
{
	...
	$query = mysqli_query($con, "SELECT * FROM " . global_mysqli_reservations_table1 . " WHERE reservation_user_id='$user_id'")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');
...
function toggle_reservation_reminder()
{
	...
	$user_id = $_SESSION['user_id'];
	mysqli_query($con, "UPDATE " . global_mysqli_users_table . " SET user_reservation_reminder = 1 - user_reservation_reminder WHERE user_id='$user_id'")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');
...
function change_user_details($user_name, $user_email, $user_password)
{
	...
	else
	{
		...
		{
			mysqli_query($con, "UPDATE " . global_mysqli_users_table . " SET user_name='$user_name', user_email='$user_email' WHERE user_id='$user_id'")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');
		}
		else
		{
			$user_password = encrypt_password($user_password);

			mysqli_query($con, "UPDATE " . global_mysqli_users_table . " SET user_name='$user_name', user_email='$user_email', user_password='$user_password' WHERE user_id='$user_id'")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');
		}

		mysqli_query($con, "UPDATE " . global_mysqli_reservations_table . " SET reservation_user_name='$user_name', reservation_user_email='$user_email' WHERE reservation_user_id='$user_id'")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysqli_error()) . '</span>');
