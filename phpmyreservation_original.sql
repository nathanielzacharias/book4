...
CREATE TABLE IF NOT EXISTS `phpmyreservation_reservations` (
  ...
  `tool_in_use` datetime NULL,
  PRIMARY KEY (`reservation_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
*/

--
-- Table structure for table `phpmyreservation_reservations002`
--

DROP TABLE IF EXISTS `phpmyreservation_reservations001`;
CREATE TABLE IF NOT EXISTS `phpmyreservation_reservations001` (
  `reservation_id` int(10) NOT NULL AUTO_INCREMENT,
  `reservation_made_time` datetime NOT NULL,
  `reservation_year` smallint(4) NOT NULL,
  `reservation_week` tinyint(2) NOT NULL,
...
DROP TABLE IF EXISTS `phpmyreservation_reservations002`;
CREATE TABLE IF NOT EXISTS `phpmyreservation_reservations002` (
  `reservation_id` int(10) NOT NULL AUTO_INCREMENT,
  `reservation_made_time` datetime NOT NULL,
  `reservation_year` smallint(4) NOT NULL,
  `reservation_week` tinyint(2) NOT NULL,
...
DROP TABLE IF EXISTS `phpmyreservation_reservations003`;
CREATE TABLE IF NOT EXISTS `phpmyreservation_reservations003` (
  `reservation_id` int(10) NOT NULL AUTO_INCREMENT,
  `reservation_made_time` datetime NOT NULL,
  `reservation_year` smallint(4) NOT NULL,
  `reservation_week` tinyint(2) NOT NULL,
...
DROP TABLE IF EXISTS `phpmyreservation_reservations004`;
CREATE TABLE IF NOT EXISTS `phpmyreservation_reservations004` (
  `reservation_id` int(10) NOT NULL AUTO_INCREMENT,
  `reservation_made_time` datetime NOT NULL,
  `reservation_year` smallint(4) NOT NULL,
  `reservation_week` tinyint(2) NOT NULL,
...
DROP TABLE IF EXISTS `phpmyreservation_reservations005`;
CREATE TABLE IF NOT EXISTS `phpmyreservation_reservations005` (
  `reservation_id` int(10) NOT NULL AUTO_INCREMENT,
  `reservation_made_time` datetime NOT NULL,
  `reservation_year` smallint(4) NOT NULL,
  `reservation_week` tinyint(2) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `phpmyreservation_pats` (
  `user_id` int(10) NOT NULL AUTO_INCREMENT,
  `pats` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `queueTime_start` datetime NOT NULL,
  `queueTime_end` datetime NOT NULL,
  `user_is_admin` tinyint(1) NOT NULL,
  `user_email` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `user_password` varchar(1000) COLLATE utf8_unicode_ci NOT NULL,
  `user_name` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
